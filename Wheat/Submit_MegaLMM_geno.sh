...
#SBATCH -J MegaLMM_g_Kr


module load R

Rscript MegaLMM_Krause_geno_collectResults.R $SLURM_ARRAY_TASK_ID > logs/MegaLMM_Krause_geno_collectResults_$SLURM_ARRAY_TASK_ID.Rout
